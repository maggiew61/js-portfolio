...
for(i=4; i<result.length;i++){
	str2 += "<td><div><img src='"+ result[i].imgsrc+"'/>"+ "<p>"+result[i].name+"</p>"+"<p>"+"View Count"+result[i].viewcount+"</p>"+"<p>"+"NT$" + result[i].price+"</p>"+ "</div>"+"</td>";
	document.getElementById('sortTable2').innerHTML=str2;
}

function setDefault(){
	document.getElementById('numbers').textContent="Total: ( "+result.length+" ) items found";
}
setDefault()
