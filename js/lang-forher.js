...
var opt;
if(x==="zn"){
	opt=document.querySelector('option[value="forher-cn.html"]'); //assign opt w/ the option[value="index2.html"] element
} else if(x==="en"){
	opt=document.querySelector('option[value="forher.html"]');//assign opt w/ the option[value="en.html""] element
}
